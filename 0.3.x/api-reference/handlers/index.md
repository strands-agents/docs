...
| Name | Type | Description | Default | | --- | --- | --- | --- | | `tool` | `ToolUse` | The tool object to process, containing name and parameters. | *required* | | `model` | `Model` | The model being used for the agent. | *required* | | `system_prompt` | `Optional[str]` | The system prompt for the agent. | *required* | | `messages` | `Messages` | The conversation history. | *required* | | `tool_config` | `ToolConfig` | Configuration for the tool. | *required* | | `kwargs` | `dict[str, Any]` | Additional keyword arguments passed to the tool. | *required* |
...
| Type | Description | | --- | --- | | `ToolGenerator` | The final tool result or an error response if the tool fails or is not found. |
