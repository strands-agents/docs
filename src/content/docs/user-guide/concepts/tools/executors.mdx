...
Custom tool executors are currently only supported in Python.
:::

In Python, you can create custom executors by subclassing `ToolExecutor`. You can track progress on this feature at [GitHub Issue #762](https://github.com/strands-agents/sdk-python/issues/762).
