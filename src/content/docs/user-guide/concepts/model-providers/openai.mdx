...
The OpenAI Chat Completions provider does not have a native token counting API. It uses a character-based heuristic (characters ÷ 4 for text, characters ÷ 2 for JSON).
</Tab>
<Tab label="TypeScript">
