...
Graph, Swarm, and Workflow are different methods of orchestration. Graph and Swarm are core SDK components. Workflow is available as a tool from `strands-agents-tools`.
