...
- [**SummarizingConversationManager**](#summarizingconversationmanager) (Python) / [**SummarizationConversationManager**](#summarizingconversationmanager) (TypeScript): Intelligently summarizes older messages to preserve context
...
The [`SummarizingConversationManager`](@api/python/strands.agent.conversation_manager.summarizing_conversation_manager#SummarizingConversationManager) (Python) / `SummarizationConversationManager` (TypeScript) implements intelligent conversation context management by summarizing older messages instead of simply discarding them. This approach preserves important information while staying within context limits.
...
- **`model`** (Model, required): The model to use for generating summaries.
...
The `SummarizationConversationManager` requires a `model` to use for generating summaries. This can be any model supported by the SDK.

```typescript
--8<-- "user-guide/concepts/agents/conversation-management_imports.ts:summarization_conversation_manager_basic_imports"

--8<-- "user-guide/concepts/agents/conversation-management.ts:summarization_conversation_manager_basic"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/concepts/agents/conversation-management_imports.ts:summarization_conversation_manager_custom_imports"

--8<-- "user-guide/concepts/agents/conversation-management.ts:summarization_conversation_manager_custom"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/concepts/agents/conversation-management_imports.ts:summarization_conversation_manager_system_prompt_imports"

--8<-- "user-guide/concepts/agents/conversation-management.ts:summarization_conversation_manager_system_prompt"
```
</Tab>
</Tabs>
