...
| `AfterInvocationEvent`             | Triggered at the end of an agent request, regardless of success or failure. Supports `resume` to trigger follow-up invocations. Uses reverse callback ordering    |
