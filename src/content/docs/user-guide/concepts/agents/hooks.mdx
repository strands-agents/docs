...
- **invocationState**: Per-invocation state forwarded to every node's child agent — see [Shared State Across Multi-Agent Patterns](../multi-agent/multi-agent-patterns.md#shared-state-across-multi-agent-patterns)
</Tab>
</Tabs>
