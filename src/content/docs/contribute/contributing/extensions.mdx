...
:::tip
You don't have to use the template. If you already have a project structure you prefer, skip ahead to [What you can publish](#what-you-can-publish) for the extension points available.
:::
