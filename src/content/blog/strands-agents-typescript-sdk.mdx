---
title: "Strands Agents TypeScript SDK: Build Production Agents in TypeScript"
date: 2026-04-06
...
--8<-- "../blog/strands-agents-typescript-sdk.ts:plugins"
```
...
--8<-- "../blog/strands-agents-typescript-sdk.ts:agent_as_tool"
```
...
--8<-- "../blog/strands-agents-typescript-sdk.ts:graph"
```
...
--8<-- "../blog/strands-agents-typescript-sdk.ts:swarm"
```
