...
The full example includes a settings panel for switching between OpenAI, Anthropic, and Bedrock providers, a chat UI with streaming markdown rendering, and tool-use indicators. Clone the repo and try it out:
...
Open `http://localhost:5173`, configure your API credentials, and start chatting with the canvas.
...
- [Documentation](https://strandsagents.com) for guides and API reference
- [GitHub](https://github.com/strands-agents/sdk-typescript) for source code and examples

We're building this in the open and contributions are welcome. Whether it's a bug report, a new model provider, or a cool example, we'd love to see what you build. Join us [on GitHub](https://github.com/strands-agents/sdk-typescript) and let us know what you think.
