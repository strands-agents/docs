-   **Classes**
    ...
    -   [SummarizationConversationManager](/docs/api/typescript/SummarizationConversationManager/index.md)
...
-   **Type Aliases**
    ...
    -   [SummarizationConversationManagerConfig](/docs/api/typescript/SummarizationConversationManagerConfig/index.md)
