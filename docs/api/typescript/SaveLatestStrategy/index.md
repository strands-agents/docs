...
Defined in: [src/session/session-manager.ts:41](https://github.com/strands-agents/sdk-typescript/blob/a12ea3e3c4680daacc8ca5937b6b8be41474c92b/strands-ts/src/session/session-manager.ts#L41)
